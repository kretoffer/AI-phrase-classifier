...
class EditForm(BaseModel):
    ...
    hidden_layer: int = Field(
        50,
        gt=0,
        title="hidden neurouns",
        description="the count of neurons in hidden layer",
    )
    ...
    activation_method: Literal[
        "relu", "sigmoid", "tanh", "leaky relu", "softmax", "swish", "mish"
    ] = Field("relu")
