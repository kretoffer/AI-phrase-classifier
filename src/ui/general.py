...
@router.get("/", response_model=FastUI, response_model_exclude_none=True, tags=["fast ui interface"])
def main_web():
...
@router.get("/project/{name}", response_model=FastUI, response_model_exclude_none=True, tags=["fast ui interface"])
